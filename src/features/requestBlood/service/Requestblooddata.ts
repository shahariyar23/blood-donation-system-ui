...
export const validateRequest = (
  ...
  else if (values.units > 10) errors.units = "Maximum 10 units allowed";

  if (!values.hospital.trim()) errors.hospital = "Hospital name is required";
  ...
  if (!values.urgency) errors.urgency = "Please select urgency level";

  if (!values.neededBy) errors.neededBy = "Required date is needed";
...
export const requestFields: Field[] = [
  ...
  },
  {
    name: "agreeTerms",
    label:
      "I confirm that this is a genuine blood request and the information provided is accurate.",
    type: "checkbox",
    required: true,
    colSpan: "full",
  },
